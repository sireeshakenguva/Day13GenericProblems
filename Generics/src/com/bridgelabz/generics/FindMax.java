...
public class FindMax<T extends Comparable<T>> {
    ...
    public static void main(String[] args) {
        Integer intValue1 = 400, intValue2 = 300, intValue3 = 60;
        Float floatValue1 = 4.3f, floatValue2 = 3.5f, floatValue3 = 8.7f;
        String stringValue1 = "Sireesha", stringValue2 = "Rajeshnaidu", stringValue3 = "Kenguva";
